          ...
          <Form method="post" className="space-y-6" replace>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div>
                      ...
                      <div className="mt-2">
                        <input type="nom" name="nom" id="nom" required className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                      </div>
                  ...
                  <div>
                      ...
                      <div className="mt-2">
                        <input type="prenom" name="prenom" id="prenom" required className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                      </div>
                  ...
                  <div>
                      ...
                      <div className="mt-2">
                        <input type="password" name="confirmation-password" id="confirmation-password" required className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                      </div>
                  </div>
                  <div>
                      <label htmlFor="role" className="block text-sm/6 font-medium text-gray-900">Role</label>
                      <div className="flex items-center mt-2 mb-4">
                          <input id="htmlFormateur" type="radio" name="role" value="formateur" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                          <label htmlFor="formateur" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Formateur</label>
                      </div>
                      <div className="flex items-center">
                          <input id="surveillant" type="radio" name="role" value="surveillant" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
